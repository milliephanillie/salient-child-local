...
<h1 class="mepr_page_header"><?php echo esc_html_x( 'Account', 'ui', 'memberpress' ); ?></h1>
<!-- 
...
<div class="mepr-profile-wrapper">
  <div class="mepr-profile-wrapper__footer">
    <a class="mepr-button btn-outline btn btn-outline" href="<?php echo esc_url_raw( MeprHooks::apply_filters( 'mepr-account-nav-subscriptions-link', $account_url . $delim . 'action=subscriptions' ) ); ?>"><?php echo esc_html_x( 'TWW+ Membership', 'ui', 'memberpress' ); ?></a>
  ...
  <dl class="mepr-profile-details__list">
    ...
    <div style="display: flex; padding: 20px 0;">
        <a class="brand-green" href="https://www.thewellnessway.com/wp-login.php?action=logout">Logout Now</a>
    </div>
  </dl>
  </div>
