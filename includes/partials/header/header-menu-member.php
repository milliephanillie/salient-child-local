	...
	<div class="container">
		<div class="row">
			<div class="col span_3">
				...
				<a id="logo" href="<?php echo site_url(); ?>" data-supplied-ml-starting-dark="<?php echo esc_attr( $nectar_header_options['using_mobile_logo_starting_dark'] ); ?>" data-supplied-ml-starting="<?php echo esc_attr( $nectar_header_options['using_mobile_logo_starting'] ); ?>" data-supplied-ml="<?php echo esc_attr( $nectar_header_options['using_mobile_logo'] ); ?>" <?php echo wp_kses_post( $nectar_header_options['logo_class'] ); ?>>
                 <?php
               // echo '<img class="' . $default_logo_class . '" width="'.nectar_logo_dimensions('width', $nectar_options['header-starting-logo']).'" height="'.nectar_logo_dimensions('height', $nectar_options['header-starting-logo']).'" alt="' . esc_html( $salient_logo_text ) . '" src="' . nectar_options_img( $nectar_options['header-starting-logo'] ) . '" ' . $starting_retina_srcset . ' />';
                ?> 
			...
			<?php 
			$dissallow_list = apply_filters('tww_hide_menu_for_post_types', array('memberpressproduct'));  
			global $post;
			if ( ! in_array(get_post_type($post), $dissallow_list) ) {
			?>
